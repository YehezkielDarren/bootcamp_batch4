...
contract FlashloanTest is Test {
    ...
    function setUp() public{
        vm.createSelectFork("https://arb-mainnet.g.alchemy.com/v2/-K_wplV8cA5HPqQTYkgD9nlVypVBGJEu", 335106679);
    ...
    function test_loopingSupply() public {
        ...
        console.log("uaWeth balance", IERC20(aWeth).balanceOf(address(flashloan)));
    }

...
contract Flashloan {
    ...
    function receiveFlashLoan(
        ...
        IERC20(usdc).approve(uniswapRouter, amounts[0]); // Use amounts[0] instead of amountIn
        ...
        uint256 outputWeth = ISwapRouter(uniswapRouter).exactInputSingle(params); // Capture the return value

        // supply ke aave
        uint256 totalEth = supplyAmount + outputWeth; // Now outputWeth is defined
